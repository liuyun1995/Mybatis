...
public abstract class VFS {
	 ...
	 * @param object
	 *            The instance or class (for static methods) on which to invoke the
	 *            method.
	 * @param parameters
	 ...
	 * @param forPath
	 *            The path to the resource that is identified by the URL. Generally,
	 *            this is the value passed to {@link #getResources(String)} to get
	 *            the resource URL.
